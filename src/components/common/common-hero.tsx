...
export default function CommonHero({ subtleHeading, subheading, heading, buttontitle }: commonHeroType) {
    ...
    return (
        <section className="relative h-full md:h-screen w-full pt-28 md:mt-0 bg-white dark:bg-gray-950 md:py-20 px-4 flex items-center overflow-hidden">
            ...
            {/* Floating Circles */}
            <motion.div
                className="absolute top-40 left-20 w-16 h-16 rounded-full bg-gradient-to-br from-pink-400 to-pink-600 opacity-20"
                animate={{
                    y: [0, -30, 0],
                    x: [0, 15, 0],
                }}
            ...
            />
            <motion.div
                className="absolute bottom-40 right-32 w-24 h-24 rounded-full bg-gradient-to-br from-pink-300 to-pink-500 opacity-15"
                animate={{
                    y: [0, 25, 0],
                    x: [0, -20, 0],
                }}
