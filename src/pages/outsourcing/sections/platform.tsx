                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16 items-center">
                        ...
                        <div className="flex justify-center lg:justify-start">
                            <div className="relative w-full max-w-sm">
                                <img
                                    src="https://placehold.co/400x300/8b5cf6/white?text=Platform+Demo"
                        ...
                        <div className="space-y-8">
                            <div>
                                ...
                                <Button className="bg-white text-neutral-900 hover:bg-neutral-100 px-6 py-6 rounded-full font-semibold">
                                    Book a demo
                                </Button>
                            </div>
                            ...
                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-6 md:gap-8">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-lg md:text-xl font-bold text-white">Hire</h3>
                                    </div>
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-lg md:text-xl font-bold text-white">Pay</h3>
                                    </div>
                                    <p className="text-sm text-neutral-300">
                                ...
                                <div className="space-y-2">
                                    <div className="flex items-center gap-2">
                                        ...
                                        <h3 className="text-lg md:text-xl font-bold text-white">Manage</h3>
                                    </div>
                                    <p className="text-sm text-neutral-300">
