export default function AboutUs() {
  ...
  return (
    <section className="bg-green-600 py-16 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="relative">
            ...
            <div className="absolute -bottom-8 -right-8 w-48 h-48 rounded-full overflow-hidden border-6 border-white shadow-xl">
              <img 
          ...
          <div className="text-white">
            ...
            {/* CTA Button */}
            <button className="bg-green-400 hover:bg-green-300 text-green-900 font-semibold px-8 py-3 rounded-full transition-colors duration-200 flex items-center">
              Know more
