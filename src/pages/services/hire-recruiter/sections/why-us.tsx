export default function WhyUs() {
  ...
  return (
    <section className="bg-gray-100 py-16 px-4 sm:px-6 lg:px-8 rounded-4xl">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="text-center mb-16">
          <div className="inline-block border-2 border-gray-400 rounded-full px-6 py-2 mb-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 lg:gap-12">
          {features.map((feature, index) => (
            <div key={index} className="bg-white rounded-2xl p-8 shadow-sm">
              {/* Green dot indicator */}
              <div className="w-4 h-4 bg-green-500 rounded-full mb-6"></div>
