  ...
  return (
    <section className="relative h-svh md:h-full md:min-h-screen isolate overflow-hidden bg-white dark:bg-black text-gray-900 dark:text-white">
      ...
      <div aria-hidden className="pointer-events-none absolute inset-0 -z-10 select-none">
        <AvatarChip position="left-8 top-40 hidden md:block" src={home.mp} alt="SDE" label="SDE" labelClass="bg-green-400 text-black" />
        ...
        <AvatarChip position="right-24 bottom-16 hidden md:block" src={home.tool} alt="CS" label="CS" labelClass="bg-purple-300 text-black" />
