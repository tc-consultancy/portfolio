    ...
    return (
        <>
            ...
            <section className="w-full py-12   max-w-6xl mx-auto">
                ...
                <p className="text-base md:text-xl  text-white/70 mb-6 leading-tight max-w-4xl">TC Services, in collaboration with Securiti.ai, enables organizations to safely utilize the extraordinary power of data and the cloud by regulating the complex security, compliance, and privacy risks.</p>
